      ...
      <div className="mx-auto w-full max-w-screen-xl p-6 py-12 lg:py-16">
        <div className="md:flex md:justify-between gap-12">
          <div className="mb-8 md:mb-0 max-w-sm">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mt-4">
              Nexis Premium E-Commerce. Discover a curated catalog of high-end accessories, smartphones, smartwatches, shoes, and luxury skincare products. Designed for elegance, built for speed.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 flex-1 md:justify-items-end">
            <div>
              <h2 className="mb-5 text-xs font-semibold text-white uppercase tracking-wider">Shop Pages</h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-xs text-slate-500 sm:text-center">
            © {new Date().getFullYear()} Nexis E-Shop. All Rights Reserved.
          </span>
