    ...
    <section className="mt-12 w-full">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {STATS.map(({ icon: Icon, value, key }) => (
          <div
            key={key}
            className="bg-white/90 border border-brand-100 rounded-2xl p-5 text-center shadow-soft hover:shadow-card hover:border-brand-300 transition-all duration-300"
          >
